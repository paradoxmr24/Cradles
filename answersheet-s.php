...
<h4 class="mb-4">
<?php
$query = "SELECT *,answers.Marks AS Mks FROM answers INNER JOIN `$e_id` WHERE `$e_id`.Id = answers.Answer_id && answers.Exam_id='$e_id' && answers.Student_id='$_SESSION[username]' && answers.Answer_id > '$serial' && answers.Image != 'none'";
...
<form method="POST" action="">
    ...
    <?php 
      $query1 = "SELECT * FROM answers WHERE Exam_id='$e_id' && Student_id='$_SESSION[username]' && Image != 'none'";
